...
+ 运行容器
  ...
  -v /store/zpbird/dockerfiles/webserver/nginx/conf.d:/etc/nginx/conf.d \
  -v /store/zpbird/dockerfiles/webserver/nginx/nginx.conf:/etc/nginx/nginx.conf \
  -v /store/zpbird/project/app_ttjt/logs/nginx:/var/log/nginx \
...
+ 范例
  ...
  -v /store/zpbird/project/app_ttjt:/app \
  -v /etc/localtime:/etc/localtime \
  zpbird/flask:0.5
  或
  docker run --rm -d -p 7012:7012 --name flask-test  --net zpbr0 --ip 172.70.0.12\
